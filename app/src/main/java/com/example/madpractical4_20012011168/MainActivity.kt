package com.example.madpractical4_20012011168
...
import android.provider.ContactsContract import android.provider.MediaStore
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) { super.onCreate(savedInstanceState)
        ...
        buttonContact.setOnClickListener{
            ...
            Intent(Intent.ACTION_VIEW).setType(ContactsContract.Contacts.CONTENT_T YPE).apply { startActivity(this) }
        }

        var buttonCallLog = findViewById<Button>(R.id.button_calllog) buttonCallLog.setOnClickListener{

            Intent(Intent.ACTION_VIEW).setType(CallLog.Calls.CONTENT_TYPE).apply { startActivity(this) }
        }

        var buttonGallery = findViewById<Button>(R.id.button_gallery) buttonGallery.setOnClickListener{Intent(Intent.ACTION_VIEW).setType("image/*").apply startActivity(this) }
    }
    var buttonCamera = findViewById<Button>(R.id.button_camera) buttonCamera.setOnClickListener{
